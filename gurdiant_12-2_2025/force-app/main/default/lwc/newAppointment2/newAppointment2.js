...
export default class NewAppointment extends LightningElement {
 ...
 @track value = '';
    ...
    @track providerComp = "a1MWr000001PsO1MAK";
     // Wire the CurrentPageReference to extract the recordId from the URL
    ...
    handleEndTimeChange(event) {
        ...
        if (this.startTime && this.endTimeU) {
    ...
    @track selectedDurationU; // Track this variable so it automatically updates the UI
        ...
        // Use recordId when the component is initialized
    ...
    //     console.log('hlww');
    //     this.accountID =   this._recordId;
    //     console.log('Record ID passed from Action:',  this.accountID);
    ...
    filterProviderTypes() {
        ...
        for (const element of this.allProviderTypes) {
            if (element.Resource_Category__c == this.selectedCareCatID && element.Clinic_Location__c == this.selectedgrpLocationID && element.Appointment_Type__c == this.selectedAppTypeID) {
    ...
    filterProviers() {
        ...
        for (const element of this.allProviders) {
            if (element.Appointment_Type__c == this.selectedAppTypeID && element.Clinic_Location__c == this.selectedgrpLocationID && element.Resource_Type__c == this.selectedProviderTypeID) {
...
if( this.providerOptions.length > 0){
    ...
    handleEndTimeChangeU(event) {
        ...
        this.appointment.End_Time__c = endTime;
        this.endTimeU = endTime;
    ...
    checkStartDateEnable() {
        // console.log('hummmmm5');
        // if(this.selectedProviderTypeID != null && this.selectedDuration != null  && this.selectedgrpLocationID != null && this.selectedCareCatID != null &&  this.appointment.Appointed_Date__c != null){
        if (this.selectedDateU != '') {
            this.isStartDateDisabled = true;
        }
        // this.isStartDateDisabled = false;
        ...
        // console.log('hummmmm2');


        // if (this.appointment.Clinic_Resource__c == null) {

        // } else {
        //     temp = this.selectedProvider;
        // }
        // console.log(this.selectedProviderTypeID);
        // console.log( this.selectedDuration);
        // console.log(this.selectedgrpLocationID);
        // console.log(this.selectedCareCatID);
        // console.log(this.appointment.Appointed_Date__c);
        // console.log(temp);
        // console.log('hellooooo' +this.selectedProviderTypeID);
        if (this.appointment.Appointed_Date__c == null) {
            ...
            if (this.selectedProviderTypeID == null) {
                this.selectedProviderTypeID = '';
            }
            if (this.selectedDuration == null) {
                this.selectedDuration = '';
            }
            if (this.selectedgrpLocationID == null) {
                this.selectedgrpLocationID = '';
            }
            if (this.selectedCareCatID == null) {
                this.selectedCareCatID = '';
            }
            if (this.appointment.Appointed_Date__c == null) {
                this.appointment.Appointed_Date__c = '';
            }
            let providertype;
            let appduration;
            let locationid;
